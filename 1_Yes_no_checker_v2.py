...
loop = True
while loop:
    # asks the user yes or no this is just for testing then stores it as yes_or_no. It also stirp's and lowers the variable
    yes_or_no = input("yes or no ? ").strip().lower()
